...
#' @export
svmvgHMM=function(y, y0=0.2, theta_init, m, gmax, nIS=1e3){
  ...
  Results=ISdiag(Weigth=Weigth, X=X, normal=FALSE, p=svmvg.pw2pn)
  ...
  #for(j in 1:nIS){
  #  pv=X[j,]
  #  Dbar=Dbar+Weigth[j]*svmvg.mllk(parvect=pv,y=y,y0=y0,m=m,gmax=gmax)
  #}
  #Dbar=2*Dbar
  #pd=Dbar-D
  #DIC=D+2*pd
